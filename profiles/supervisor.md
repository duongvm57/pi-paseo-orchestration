...
- Treat the observation loop as event-triggered work, not a persistent process. Follow the Workspace Protocol's observation rhythm: one bounded observation pass per event or safety-net heartbeat, then idle. This step is complete when the pass has finished and the Supervisor is idle.
