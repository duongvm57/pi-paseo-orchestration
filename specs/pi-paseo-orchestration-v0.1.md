...
1. **Package and relocation:** exactly one extension and one skill; profiles remain private; no prompt/theme/example; no adapter dependency or install script; fresh config roots, copied development roots, and unrelated cwd resolve resources; missing/empty/non-regular/symlink-escaped resources block.
