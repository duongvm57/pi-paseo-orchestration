...
3. **Bind Supervisor and Lead.** The Human announces the exact Supervisor agent ID to the Lead. The Lead verifies that Supervisor's role, root parentage, repository/workspace applicability, and task binding before accepting it. The Supervisor may ask that bound Lead or relay a Human decision to it.
