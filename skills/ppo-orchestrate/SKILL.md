...
2. Accept the Human task directly. The runtime captures it as the current-run Human task authority. Do not ask the Human to write markers, JSON, hashes, agent IDs, assignment IDs, scope syntax, or capability names.
